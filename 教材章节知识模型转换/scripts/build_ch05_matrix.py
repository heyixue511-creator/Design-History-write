...
JUDGMENT = {
    ...
    "5.2": "A级三项以B0345（消费作为现代性发动机、美国消费体系）与B0409（de Grazia：福特主义分配回路、广告营销专业化）为核心；B级十二项构成制度要素网（广告、连锁、百货），B0376（Marchand广告与现代性）补广告产业侧、B0401（Sparke二版）与B0143（时尚现代性）补消费文化侧；B0080/B0145补充时尚与性别化消费；“美国化”与“消费者主权vs消费公民权”为比较框架命题。",
    "5.3": "A级十项以B0206（消费工程学理论考古、人为废弃、行为主义）与B0205/B0066（Calkins消费不足论、Fortune命名、销售吸引力标准）为核心，B0186（Dreyfuss P0：客户关系、收费模式透明化）提供行动者实务侧，B0503（王受之教材）作中文通史参照；Sheldon & Arens《Consumer Engineering》(1932)为关键P0文本；销售工程是“当事人话语+Meikle批判分析”双层证据。",
    ...
    "5.5": "A级十四项覆盖职业命名（B0066 Fortune 1934）、四巨头出身（B0206）、咨询设计职业生成（B0345）、室内装饰女性职业（B0022）、Dreyfuss P0自述（B0186）、职业组织沿革（B0066）；B0401（Sparke二版）补充咨询设计职业的战后延续；职业史命题与B0206去重后计P0；匿名从业者材料仍缺。",
