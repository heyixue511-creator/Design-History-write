...
JUDGMENT = {
    ...
    "7.4": "A级两项全由B0235（乌尔姆课程与关闭、乌尔姆—布劳恩设计联系）承担；B级补B0401（Sparke）、B0234（词典）、B0415（《Design After Modernism》对科学化设计方法的批评侧）；B0411（雷曼教学著作）作乌尔姆遗产向中国传播的行动者侧；“制度化完成”类判断为作者命题须标注。",
    "7.5": "全节5条均为B级（B0235/B0234/B0401/B0503），无A级——布劳恩专史未入批，保持B级准入；拉姆斯十原则、1957米兰三年展大奖等通用史实与B0101/B0102去重；后续补证批次（布劳恩/联邦德国设计专史）可提升准入。",
    "7.6": "全章结构最强节：A级三项＝B0076（Fiell图录：北欧作品视觉档案）与B0388（Fallan主编：咖啡桌书体裁批判、斯堪的纳维亚设计作为被发明的范畴）两项构成档案侧与批判侧正反对勘；B级补B0503/B0235；“被发明的范畴”为史学批判命题须标注；Lunning Prize、Svenska Slöjdföreningen、Design in Scandinavia巡展等同一对象只计一份P0。",
