#!/usr/bin/env python3
"""Complete Raizman edition group: B0102 (2023 3rd ed.), B0478 (2013 zh translation).

Reads semantic-review JSONs from BATCH-003-CH02-EXPANDED/review_data/ and
generates source cards (JSON+MD), section mapping CSVs, and updates manifest.
"""
...
def write_source(source_id: str, data: dict, asset: dict) -> None:
    ...
    md = [
        ...
        "## 一b、版本关系", "", data.get("version_relation", ""), "",
