...
d = json.load(open(r"D:\Design-history-知识库\教材章节知识模型转换\logs\_ch06_structure.json", encoding="utf-8"))
lines = []
...
Path(r"D:\Design-history-知识库\教材章节知识模型转换\logs\_ch06_stats.txt").write_text("\n".join(lines), encoding="utf-8")
