#!/usr/bin/env python3
"""Temporary verification for BATCH-006-CH05-COMMERCIAL."""
import csv, hashlib, json, re, sys
from pathlib import Path

ROOT = Path(r"D:\Design-history-知识库\教材章节知识模型转换")
BATCH = ROOT / "11_语义复核批次" / "BATCH-006-CH05-COMMERCIAL"
ASSETS = ROOT / "03_来源清单与来源卡" / "来源资产总表.csv"

ids = ["B0073", "B0206", "B0145", "B0205", "B0066", "B0409", "B0410", "B0186", "B0345", "B0436", "B0022", "B0162"]
errors, warns = [], []
